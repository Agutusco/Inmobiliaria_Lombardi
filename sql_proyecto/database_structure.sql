...
-- Otros dueños de la inmobiliaria

CREATE USER "Alma"@"%" IDENTIFIED BY "032014";
CREATE USER "Felipe"@"%" IDENTIFIED BY "092009";

-- Empleados con mayor rango para ciertos accesos
CREATE USER "Juan"@"%" IDENTIFIED BY "789";
CREATE USER "Ana"@"%" IDENTIFIED BY "987";

GRANT ALL PRIVILEGES ON  proyecto_coder.* TO "dueno";
GRANT ALL PRIVILEGES ON proyecto_coder.propiedad TO 'administrador';
GRANT ALL PRIVILEGES ON proyecto_coder.visita TO 'administrador';

-- Le damos los permisos a los duenos

GRANT ALL PRIVILEGES ON proyecto_coder.* TO "Alma"@"%";
GRANT ALL PRIVILEGES ON proyecto_coder.* TO "Felipe"@"%";

-- Le damos permisos a los empleados para que puedan anotar en la DB informacion sobre las propiedades

GRANT ALL ON proyecto_coder.propiedad TO "Juan"@"%";
GRANT ALL ON proyecto_coder.visita TO "Juan"@"%";

GRANT ALL ON proyecto_coder.propiedad TO "Ana"@"%";
GRANT ALL ON proyecto_coder.visita TO "Ana"@"%";
